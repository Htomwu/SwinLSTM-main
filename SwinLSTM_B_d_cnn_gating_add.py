...
class LocalGlobalFusionLayer(nn.Module):
    def __init__(self, local_dim, global_dim, fusion_dim):
        ...
        # 门控网络，生成 g
        self.gate_fc = nn.Linear(local_dim + global_dim, fusion_dim)
    ...
    def forward(self, local_features, global_features):
        ...
        # 融合：g 是与 local_out 同维度的向量
        fusion_out = g * local_out + (1 - g) * global_out
        fusion_out = F.relu(self.fusion_fc(fusion_out))
        return fusion_out
