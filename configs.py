...
def get_args():
    ...
    parser.add_argument('--image_size', default=(180, 360), type=int, help='Original resolution')
    parser.add_argument('--input_size', default=(180, 360), help='Input resolution')
    parser.add_argument('--step_length', default=0.1, type=float)
    parser.add_argument('--spi_data_dir', default="/home/user/Scorpion/Monthly_SPI-6_from_ERA5_195901-202212.nc")
    ...
    # model parameters
    parser.add_argument('--model', default='SwinLSTM-B', type=str, choices=['SwinLSTM-B', 'SwinLSTM-D'],
                        help='Model type')
    parser.add_argument('--input_channels', default=1, type=int, help='Number of input image channels')
    parser.add_argument('--input_img_size', default=(180,360), type=int, help='Input image size')
    ...
    # parser.add_argument('--depths_down', default=[2], type=int, help='Downsample of SwinLSTM-D')
    # parser.add_argument('--depths_up', default=[2], type=int, help='Upsample of SwinLSTM-D')
    ...
    parser.add_argument('--window_size', default=3, type=int, help='Window size of Swin Transformer layer')
    ...
    parser.add_argument('--valid_batch_size', default=4, type=int, help='Batch size for validation')
